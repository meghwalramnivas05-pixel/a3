<?php
/**
 * FuzzyStocking — contact form handler
...
$to_address = "hello@fuzzystocking.com";
...
$subject = clean_input($_POST['subject'] ?? 'New message from fuzzystocking.com');
...
$mail_body = "New contact form submission from fuzzystocking.com\n\n";
$mail_body .= "Name: {$name}\n";
$mail_body .= "Email: {$email}\n";
$mail_body .= "Subject: {$subject}\n\n";
$mail_body .= "Message:\n{$message}\n";

$headers = "From: no-reply@fuzzystocking.com\r\n";
$headers .= "Reply-To: {$email}\r\n";

$sent = @mail($to_address, "[FuzzyStocking Contact] " . $subject, $mail_body, $headers);

if ($sent) {
    echo "<!DOCTYPE html><html lang='en'><head><meta charset='UTF-8'><title>Message sent — FuzzyStocking</title>" .
